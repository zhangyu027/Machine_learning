"""Legacy/demo graph embedding and generic GCN components.

The V4.1 scientific GraphConv benchmark is defined separately in
``pharma_genai.models.graphconv`` and ``experiments/run_gnn_benchmark.py``.
This legacy module keeps the existing application interface while keeping optional heavy
