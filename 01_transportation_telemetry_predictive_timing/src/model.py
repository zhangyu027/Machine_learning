...
def train_model(
    ...
    output_tables_dir = metrics_path.parent
    output_models_dir = model_path.parent

    output_tables_dir.mkdir(parents=True, exist_ok=True)
    output_models_dir.mkdir(parents=True, exist_ok=True)

    training_loss_path = output_tables_dir / "training_loss.csv"
    confusion_matrix_path = output_tables_dir / "confusion_matrix.csv"
    ...
    pd.DataFrame({
        ...
        "loss": history,
    }).to_csv(training_loss_path, index=False)
